...
export const ToolIcon: React.FC<{ tool: ToolType, className?: string }> = ({ tool, className }) => {
  const baseClasses = "object-contain " + (className || "w-8 h-8 rounded");
  ...
  switch (tool) {
    case ToolType.PHOTOSHOP:
      return renderImage("/icons/photoshop.png", "Adobe Photoshop");
    case ToolType.BLENDER:
      return renderImage("/icons/blender.png", "Blender");
    case ToolType.SUBSTANCE_PAINTER:
      return renderImage("/icons/substance.png", "Substance Painter");
    case ToolType.ZBRUSH:
      return renderImage("/icons/zbrush.png", "ZBrush");
    case ToolType.MARVELOUS_DESIGNER:
      return renderImage("/icons/marvelous.png", "Marvelous Designer");
    case ToolType.MAYA:
      return renderImage("/icons/maya.png", "Autodesk Maya");
    default:
      return null;
  }
};